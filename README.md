...
1. Launches the OpenHands agent so it can explore the repository, gather diffs, and produce a Markdown review where every issue explicitly cites `path/to/file.py:L42` style references.
